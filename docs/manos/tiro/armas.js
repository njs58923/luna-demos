...
// pieza que se mueve; salen de los scripts de blender/, con estas medidas.
//
...
(globalThis.__modulos ||= []).push(["tiro/armas", [
  ...
  /** El pozo que sale de una empuñadura: el cargador entra por abajo y calza
   *  con la boca en `tope`, subiendo por el eje de la empuñadura. */
  ...
  const TIPOS = {
    ...
    pistola: {
      ...
      corredera: { eje: v3(0, 0, 1), largo: 0.04, agarre: v3(-0.0002, 0.0795, -0.0539), radio: 0.065, forma: "cilindro", largoZona: 0.205,
                   dir: { rumbo: 0, altura: -90, cono: 160 }, resorte: 1.5, trabaVacia: true, reciproca: true },
      pozo: pozoEnEmpunadura(v3(0, 0.039, -0.0095), -0.26, 0.1),
      construir(g, id) {
    ...
    // chica y el recorrido largo (10 cm). El cargador curvo calza con un
    // recorrido corto (3,5 cm). Se toma con dos manos por el guardamanos.
    mp5: {
      nombre: "MP5", automatica: true, rpm: 800, cierre: "cerrado",
      sonido: "disparo_mp5", nombreCorredera: "manija",
      boca: v3(0, 0.048, -0.39),
      ...
      corredera: { eje: v3(0, 0, 1), largo: 0.1, agarre: v3(-0.052, 0.07, -0.29), radio: 0.045, forma: "cilindro", largoZona: 0.08,
                   dir: { rumbo: 90, altura: 0, cono: 110 }, resorte: 1.2, trabaVacia: false },
      pozo: { entrada: resta(v3(0, 0.02, -0.12), por(ejeInclinado(0.15), 0.035)), eje: ejeInclinado(0.15), largo: 0.035, q: qEnX(0.15) },
      delantera: { punto: v3(0, 0.045, -0.27), radio: 0.08, dir: { rumbo: 0, altura: 90, cono: 120 } },
      construir(g, id) {
    ...
    ak47: {
      nombre: "AK-47", automatica: true, rpm: 600, cierre: "cerrado",
      sonido: "disparo_rifle", nombreCorredera: "manija de carga", rifle: true,
      boca: v3(0, 0.045, -0.58),
      centro: v3(0, 0.03, -0.1),
      mesa: { tabla: "rifles", dx: 0.15, dz: 0.2, alto: 0.022 },
      ...
      corredera: { eje: v3(0, 0, 1), largo: 0.1, agarre: v3(0.038, 0.05, -0.07), radio: 0.045,
                   dir: { rumbo: -90, altura: 0, cono: 120 }, resorte: 1.4, trabaVacia: false, reciproca: true },
      pozo: { entrada: resta(v3(0, 0.008, -0.125), por(ejeInclinado(0.2), 0.04)), eje: ejeInclinado(0.2), largo: 0.04, q: qEnX(0.2) },
      delantera: { punto: v3(0, 0.03, -0.32), radio: 0.08, dir: { rumbo: 0, altura: 90, cono: 120 } },
      construir(g, id) {
    ...
    m14: {
      nombre: "M14", automatica: false, rpm: 0, cierre: "cerrado",
      sonido: "disparo_rifle", nombreCorredera: "varilla de operación", rifle: true,
      boca: v3(0, 0.045, -0.7),
      centro: v3(0, 0.02, -0.12),
      mesa: { tabla: "rifles", dx: 0.05, dz: -0.33, alto: 0.024 },
      ...
      corredera: { eje: v3(0, 0, 1), largo: 0.1, agarre: v3(0.034, 0.035, -0.12), radio: 0.045,
                   dir: { rumbo: -90, altura: 0, cono: 120 }, resorte: 1.6, trabaVacia: true, reciproca: true },
      pozo: { entrada: resta(v3(0, 0.01, -0.11), por(ejeInclinado(0.05), 0.035)), eje: ejeInclinado(0.05), largo: 0.035, q: qEnX(0.05) },
      delantera: { punto: v3(0, 0.02, -0.34), radio: 0.08, dir: { rumbo: 0, altura: 90, cono: 120 } },
      construir(g, id) {
    ...
    m4: {
      nombre: "M4A1", automatica: true, rpm: 800, cierre: "cerrado",
      sonido: "disparo_rifle", nombreCorredera: "manija de carga", rifle: true,
      boca: v3(0, 0.055, -0.5),
      centro: v3(0, 0.03, -0.1),
      mesa: { tabla: "rifles", dx: 0.15, dz: -0.08, alto: 0.022 },
      patada: { ang: 0.08, atras: 0.015, ms: 70 },
      dispersion: { base: 0, porTiro: 0.09, max: 1.2, vuelve: 5 },
      subida: { porTiro: 0.35, max: 3.5, vuelve: 6 },
      contador: v3(0, 0.15, 0.03),
      empunadura: { p: v3(0, 0.025, -0.018), r: v3(5, 0, 0) },
      corredera: { eje: v3(0, 0, 1), largo: 0.07, agarre: v3(0, 0.078, 0.07), radio: 0.045,
                   dir: { rumbo: 0, altura: -90, cono: 120 }, resorte: 1.5, trabaVacia: false },
      pozo: { entrada: resta(v3(0, 0.0, -0.1), por(ejeInclinado(0.1), 0.045)), eje: ejeInclinado(0.1), largo: 0.045, q: qEnX(0.1) },
   ...
   *  el arriba, el del mando. Con la otra mano en el guardamanos, el frente va
  ...
  function poseEnMano(a, m) {
    ...
    if (a.delantera && a.posDelantera && largo(resta(a.posDelantera, m.pos)) > 0.05) {
      const g = unitario(a.tipo.delantera.punto);
      base = { p: m.pos, q: qMul(qMirando(unitario(resta(a.posDelantera, m.pos)), arriba), qConj(qMirando(g, ARRIBA))) };
    } else {
      const d = m.d || (m.q ? rotar(m.q, v3(0, -1, 0)) : ADELANTE);
      base = { p: m.pos, q: qMirando(d, arriba) };
    }
    // La empuñadura ajustada: corrida y girada respecto del mando.
    const e = a.empunadura, g = Math.PI / 180;
    if (!e.p.x && !e.p.y && !e.p.z && !e.r.x && !e.r.y && !e.r.z) return base;
    return { p: suma(base.p, rotar(base.q, e.p)), q: qMul(base.q, qDeEuler(e.r.x * g, e.r.y * g, e.r.z * g)) };
  }
  ...
  for (const a of armas) {
    a.agarrable = {
      ...
      soltar() { aLaMesa(a); S.sonar("dejar", 0.7); },
    };
  }
