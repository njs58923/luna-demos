...
export const DEMOS: Demo[] = [
  ...
  { id: "manos", dir: "server_manipulador", puerto: 2062, entrada: "/index.hsml", color: "#1E3A5A",
    nombre: "El taller de las manos", sub: "manipular, el arco y el tiro",
    descripcion: "Para los mandos de VR: mover, girar y escalar un objeto, un arco para tirarle a dianas y globos, y una galería de tiro con seis armas que se recargan a mano." },
